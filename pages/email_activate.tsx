    ...
    <>
      <div className={`${CommonMinHeight} flex`}>
        <div className="m-auto max-w-3xl px-2 sm:max-w-2xl">
          <EmailIcon className="mx-auto w-32 h-32 mb-2 sm:w-20 sm:h-20"></EmailIcon>
          <p className="text-center">An account verify email has been sent to your mailbox, please check the email to activate your account</p>
        </div>
      </div>
    </>
  )
